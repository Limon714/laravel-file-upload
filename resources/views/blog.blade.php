          ...
          <div class="col-12 col-md-6 col-lg-6 col-xl-4 mb-30">
            <article class="post-container">
              <div class="post-thumb">
                ...
                >
                  <img
                    src="{{asset('public/img/blog/blog-post-1.jpg')}}"
                    class="img-fluid"
                    alt="Blog Post"
                  />
                </a>
          ...
          <div class="col-12 col-md-6 col-lg-6 col-xl-4 mb-30">
            <article class="post-container">
              <div class="post-thumb">
                ...
                >
                  <img
                    src="{{asset('public/img/blog/blog-post-2.jpg')}}"
                    class="img-fluid"
                    alt=""
                  />
                </a>
          ...
          <div class="col-12 col-md-6 col-lg-6 col-xl-4 mb-30">
            <article class="post-container">
              <div class="post-thumb">
                ...
                >
                  <img
                    src="{{asset('public/img/blog/blog-post-3.jpg')}}"
                    class="img-fluid"
                    alt=""
                  />
                </a>
          ...
          <div class="col-12 col-md-6 col-lg-6 col-xl-4 mb-30">
            <article class="post-container">
              <div class="post-thumb">
                ...
                >
                  <img
                    src="{{asset('public/img/blog/blog-post-4.jpg')}}"
                    class="img-fluid"
                    alt=""
                  />
                </a>
          ...
          <div class="col-12 col-md-6 col-lg-6 col-xl-4 mb-30">
            <article class="post-container">
              <div class="post-thumb">
                ...
                >
                  <img
                    src="{{asset('public/img/blog/blog-post-5.jpg')}}"
                    class="img-fluid"
                    alt=""
                  />
                </a>
          ...
          <div class="col-12 col-md-6 col-lg-6 col-xl-4 mb-30">
            <article class="post-container">
              <div class="post-thumb">
                ...
                >
                  <img
                    src="{{asset('public/img/blog/blog-post-6.jpg')}}"
                    class="img-fluid"
                    alt=""
                  />
                </a>
